...
#define ESP32_RTC_FAST_CLK_FREQ_17M    17500000U
#define ESP32_RTC_FAST_CLK_FREQ_APPROX ESP32_RTC_FAST_CLK_FREQ_17M

/* Supported RTC slow clock frequencies */
#define ESP32_RTC_SLOW_CLK_FREQ_150K   150000U
#define ESP32_RTC_SLOW_CLK_FREQ_150KD256 (ESP32_RTC_FAST_CLK_FREQ_APPROX / 256)
...
#define ESP32_SPI_MODULE	11 // SPI1
#define ESP32_SPI2_MODULE	12 // SPI2
...
#define ESP32_SYSTIMER_MODULE	26
#define ESP32_SARADC_MODULE	27
#define ESP32_TEMPSENSOR_MODULE 28
#define ESP32_WIFI_MODULE	29
#define ESP32_BT_MODULE		30
#define ESP32_IEEE802154_MODULE 31
#define ESP32_COEX_MODULE	32
#define ESP32_PHY_MODULE	33
