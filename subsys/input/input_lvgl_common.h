...
#ifndef ZEPHYR_INCLUDE_INPUT_LVGL_COMMON_H_
#define ZEPHYR_INCLUDE_INPUT_LVGL_COMMON_H_
...
struct input_lvgl_common_config {
	const struct device *input_dev;
	struct k_msgq *event_msgq;
};

struct input_lvgl_common_data {
...
#define LVGL_INPUT_DECLARE(_inst, _type, _msgq_size)                                               \
	...
	INPUT_CALLBACK_DEFINE(INPUT_LVGL_DEVICE(_inst), lvgl_input_cb_##_inst);                    \
...
#endif /* ZEPHYR_INCLUDE_INPUT_LVGL_COMMON_H_ */
